...
#             logger.info("Still polling the %s with ID %s.", job_class.__name__, job.batch_job_id)
#             last_log_time = timezone.now()
...
#                 doomed_processor_job.batch_job_id,
#             )
...
#             logger.info("Waiting on downloader Nomad job %s", recreated_job.batch_job_id)
...
#                 downloader_jobs[0].batch_job_id,
#             )
...
#             no_dispatch.set("AUTO_DISPATCH_BATCH_JOBS", "False")
#             with no_dispatch:
