...
class PlatformSerializer(serializers.ModelSerializer):
    accession_code = serializers.CharField(source='platform_accession_code')
    name = serializers.CharField(source='platform_name')
    ...
    def get_pretty_name(self, obj):
        ...
        if ']' in obj['platform_name']:
            ...
            platform_base = obj['platform_name']
        return platform_base + ' (' + obj['platform_accession_code'] + ')'
