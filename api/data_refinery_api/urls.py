    ...
    url(
        ...
        include(
            [
                ...
                url(r"^organisms/(?P<taxonomy_id>[0-9a-f-]+)/$", OrganismDetail.as_view(), name="organisms_detail"),
                ...
                url(r"^processors/(?P<id>[0-9a-f-]+)/$", ProcessorDetail.as_view(), name="processors_details"),
                # Deliverables
                ...
                url(r"^jobs/survey/(?P<id>[0-9a-f-]+)/$", SurveyJobDetail.as_view(), name="survey_jobs"),
                url(r"^jobs/downloader/$", DownloaderJobList.as_view(), name="downloader_jobs"),
                url(r"^jobs/downloader/(?P<id>[0-9a-f-]+)/$", DownloaderJobDetail.as_view(), name="downloader_jobs"),
                url(r"^jobs/processor/$", ProcessorJobList.as_view(), name="processor_jobs"),
                url(r"^jobs/processor/(?P<id>[0-9a-f-]+)/$", ProcessorJobDetail.as_view(), name="processor_jobs"),
                # Dashboard Driver
                ...
                url(r"^computed_files/(?P<id>[0-9a-f-]+)/$", ComputedFilesDetail.as_view(), name="computed_files_detail"),
                url(r"^original_files/$", OriginalFileList.as_view(), name="original_files"),
                url(r"^original_files/(?P<id>[0-9a-f-]+)/$", OriginalFileDetail.as_view(), name="original_files_detail"),
                url(
                    r"^computational_results/$", ComputationalResultsList.as_view(), name="results"
                ),
                url(r"^computational_results/(?P<id>[0-9a-f-]+)/$", ComputationalResultsDetail.as_view(), name="results_detail"),
                # Compendia
