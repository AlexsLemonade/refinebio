...
class RunScanUPCTestCase(TestCase):
    ...
    def test_pcl_is_valid(self):
        ...
        comparisons performed: one which tests that the two files are
        well correlated and another that makes sure that the median
        difference between the reference file and the generated file
        is less than 10% of the standard deviation.
        """
        batch = init_objects()
