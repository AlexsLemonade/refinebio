...
class SalmonTestCase(TestCase):
    ...
    def test_salmon_quant_two_samples_single_read(self):
        ...
        # `tximport` step is launched by subprocess module in Python.  When
        # input "quant.sf" files are too large, we may have to wait for a few
        # seconds before testing the existence of rds_filename.
