...
VERSION_FILE = "data_refinery_external_smasher/_version.py"
...
setup(
    ...
    license="BSD License",
    description=("Utility to process local sequencing data"),
    url="https://github.com/data-refinery/data_refinery/tree/master/external-smasher",
    author="Kurt Wheeler",
