# This file was originally written by the bioconductor team and
# was downloaded from: https://bioconductor.org/biocLite.R
# We have included it here so that it cannot disappear or change.
