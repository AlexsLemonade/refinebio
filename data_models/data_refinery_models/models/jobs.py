...
class ProcessorJob(TimeTrackedModel):
    ...
    # it will be incremented.  At some point there will probably be
    # some code like:
...
class DownloaderJob(TimeTrackedModel):
    ...
    # These three fields are analagous to the fields with the same
    # names in ProcessorJob, see their descriptions for more
    # information
    num_retries = models.IntegerField(default=0)
    retried = models.BooleanField(default=True)
    worker_id = models.CharField(max_length=256, null=True)
